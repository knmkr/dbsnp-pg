...
wget ftp.ncbi.nih.gov/snp/organisms/human_9606/database/organism_data/b141_SNPChrPosOnRef.bcp.gz
...
# wget ftp.ncbi.nih.gov/snp/organisms/human_9606/database/organism_data/SNPAlleleFreq.bcp.gz
